defmodule Trainning.ManagementTest do
  use Trainning.DataCase

  alias Trainning.Management

  describe "projetcs" do
    ...
    test "list_projetcs/0 returns all projetcs" do
      project = project_fixture()
      assert Management.list_projetcs() == [project]
    end
